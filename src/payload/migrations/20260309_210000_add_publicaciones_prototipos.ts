...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  // 10. Indexes
  await db.execute(
    sql`CREATE INDEX IF NOT EXISTS "publicaciones_imagen_idx" ON "publicaciones" USING btree ("imagen_id");`
  );
  await db.execute(
    sql`CREATE INDEX IF NOT EXISTS "publicaciones_coleccion_idx" ON "publicaciones" USING btree ("coleccion_id");`
  );
  await db.execute(
    sql`CREATE INDEX IF NOT EXISTS "publicaciones_updated_at_idx" ON "publicaciones" USING btree ("updated_at");`
  );
  await db.execute(
    sql`CREATE INDEX IF NOT EXISTS "publicaciones_created_at_idx" ON "publicaciones" USING btree ("created_at");`
  );
  await db.execute(
    sql`CREATE INDEX IF NOT EXISTS "prototipos_boceto_idx" ON "prototipos" USING btree ("boceto_id");`
  );
  await db.execute(
    sql`CREATE INDEX IF NOT EXISTS "prototipos_coleccion_idx" ON "prototipos" USING btree ("coleccion_id");`
  );
  await db.execute(
    sql`CREATE INDEX IF NOT EXISTS "prototipos_updated_at_idx" ON "prototipos" USING btree ("updated_at");`
  );
  await db.execute(
    sql`CREATE INDEX IF NOT EXISTS "prototipos_created_at_idx" ON "prototipos" USING btree ("created_at");`
  );
  await db.execute(
    sql`CREATE INDEX IF NOT EXISTS "prototipos_rels_order_idx" ON "prototipos_rels" USING btree ("order");`
  );
  await db.execute(
    sql`CREATE INDEX IF NOT EXISTS "prototipos_rels_parent_idx" ON "prototipos_rels" USING btree ("parent_id");`
  );
  await db.execute(
    sql`CREATE INDEX IF NOT EXISTS "prototipos_rels_path_idx" ON "prototipos_rels" USING btree ("path");`
  );
  await db.execute(
    sql`CREATE INDEX IF NOT EXISTS "prototipos_rels_telas_id_idx" ON "prototipos_rels" USING btree ("telas_id");`
  );
  await db.execute(
    sql`CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_prototipos_id_idx" ON "payload_locked_documents_rels" USING btree ("prototipos_id");`
  );
  await db.execute(
    sql`CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_publicaciones_id_idx" ON "payload_locked_documents_rels" USING btree ("publicaciones_id");`
  );
}
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  await db.execute(
    sql`ALTER TABLE "payload_locked_documents_rels" DROP COLUMN IF EXISTS "prototipos_id";`
  );
  await db.execute(
    sql`ALTER TABLE "payload_locked_documents_rels" DROP COLUMN IF EXISTS "publicaciones_id";`
  );
