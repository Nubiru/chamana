// =====================================================
// Configuración de Base de Datos - Fase 1: Primera Forma Normal (1NF)
...
const dbConfig = {
  ...
  host: process.env.DB_HOST || '127.0.0.1', // IPv4 explicit to avoid IPv6 issues
  database: process.env.DB_NAME || 'chamana_db_fase1',
